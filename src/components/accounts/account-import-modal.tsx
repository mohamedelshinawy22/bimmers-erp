...
const typeDisplay = (type: string) => type === "SUPPLIER" ? "مورد" : type === "WORKSHOP_BMW" ? "ورشة BMW" : type === "EXPENSE" ? "مصروف" : "عميل";
const numericBalance = (value: ImportRow["openingBalance"]) => {
