...
export function BarcodeDesignerClient() {
  ...
  useEffect(() => {
    let active = true;
    void getPrintableBarcodePartsAction().then((result) => {
      if (!active) return;
